class Game {
  ...
  showFuelBar(){
    push();
    image(fuelImage, width/2 - 150, height - player.positionY - 300, 20,20);
    fill ("white");
    rect(width/2 - 120, height - player.positionY - 300, 185, 20);
    fill("#ffc400");
    rect(width/2 - 120, height - player.positionY - 300, player.fuel, 20);
    noStroke();
    pop();
  }
  ...
  showLife(){
    push();
    image(lifeImage, width/2 - 150 , height - player.positionY - 350,20,20);
    fill("white");
    rect(width/2 - 120, height - player.positionY - 350, 185,20);
    fill("#f50057");
    rect(width/2 - 120, height - player.positionY - 350, player.life, 20);
    noStroke();
    pop();
  }
  handleFuel(index) {
